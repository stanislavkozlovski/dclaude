...
- `@anthropic-ai/claude-code@2.1.274`
- `@openai/codex@0.154.0`
- `cx 0.7.2`

The Codex full-access launcher was validated against `codex-cli 0.154.0`, which supports `--dangerously-bypass-approvals-and-sandbox`.
